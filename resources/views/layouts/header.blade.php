...
<body class="text-lg tracking-wide text-black bg-cover" style="background-image: url(img/background.jpg)">
    <nav class=" p-6 flex justify-between m-3 rounded bg-gray-200/50">
        <ul class='flex items-center '>
            ...
            <li>
                <a class="p-4 opacity-60 rounded hover:bg-gray-200/75 " href="">Recept toevoegen</a>
            </li>
        </ul>
        ...
        @auth
            <li>
                <a class="p-4 opacity-60 rounded hover:bg-gray-200/75" href="{{ route('gebruikersprofiel') }}">{{auth()->user()->gebruikersnaam}}</a>
            </li>
            <li>
